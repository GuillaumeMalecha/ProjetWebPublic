 ...
 */
final class Version20201005174524 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, photo_id INT DEFAULT NULL, logo_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_E01FBE6A7E9E4C8C (photo_id), INDEX IDX_E01FBE6AF98F144A (logo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE internaute (id INT AUTO_INCREMENT NOT NULL, profil_id INT DEFAULT NULL, avatar_id INT DEFAULT NULL, newsletter TINYINT(1) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6C8E97CC275ED078 (profil_id), UNIQUE INDEX UNIQ_6C8E97CC86383B10 (avatar_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, adresse_cp_id INT NOT NULL, adresse_localite_id INT NOT NULL, adresse_commune_id INT NOT NULL, adresse_num VARCHAR(255) NOT NULL, adresse_rue VARCHAR(255) NOT NULL, banni TINYINT(1) NOT NULL, e_mail VARCHAR(255) DEFAULT NULL, inscript_conf TINYINT(1) NOT NULL, inscription DATETIME NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, nb_essais_infructueux INT NOT NULL, type_utilisateur VARCHAR(255) NOT NULL, INDEX IDX_1D1C63B385CF3708 (adresse_cp_id), INDEX IDX_1D1C63B35C432B5A (adresse_localite_id), INDEX IDX_1D1C63B37C073F05 (adresse_commune_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE images DROP FOREIGN KEY FK_E01FBE6AF98F144A');
